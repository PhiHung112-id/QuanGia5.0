...
<head>
    <meta charset="UTF-8">
    <title>Hợp đồng thuê nhà - <?php echo ucwords($name) ?></title>
    <style>
...
<div class="page">
    ...
    <p>Hôm nay, ngày <?php echo date('d') ?> tháng <?php echo date('m') ?> năm <?php echo date('Y') ?>, tại địa chỉ nhà trọ.</p>
    ...
    <p>Ông/Bà: <span class="bold" style="text-transform: uppercase;"><?php echo $name ?></span></p>
    <p>Email: <?php echo $email ?></p>
    <p>Số điện thoại: <?php echo $contact ?></p>

    <div class="section-title">NỘI DUNG HỢP ĐỒNG:</div>
    <p>Hai bên thỏa thuận việc thuê phòng trọ với các điều khoản sau:</p>

    <p><span class="bold">Điều 1:</span> Bên A đồng ý cho bên B thuê phòng trọ số <span class="bold"><?php echo $house_no ?></span> tại địa chỉ nêu trên để ở.</p>

    <p><span class="bold">Điều 2:</span> Giá thuê phòng là: <span class="bold"><?php echo number_format($price, 0, ',', '.') ?> VNĐ/tháng</span>.</p>
    <p>- Tiền điện: Theo giá nhà nước (hoặc 3.500đ/kwh).</p>
    <p>- Tiền nước: 15.000đ/khối (hoặc theo đầu người).</p>

    <p><span class="bold">Điều 3:</span> Thời hạn thuê bắt đầu từ ngày: <span class="bold"><?php echo date('d/m/Y', strtotime($date_in)) ?></span>.</p>
